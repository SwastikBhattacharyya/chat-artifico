...
class ChatView(CTkToplevel):
    def __init__(self):
        ...
        self.add_contact_frame: CTkFrame = CTkFrame(self, fg_color='blue', width=300, height=170, corner_radius=0)
        ...
        self.contacts_list_frame: CTkScrollableFrame = CTkScrollableFrame(self, fg_color='green', width=300, height=530,
                                                                          corner_radius=0)
        ...
        self.contact_frame: CTkFrame = CTkFrame(self, fg_color='red', width=960, height=60, corner_radius=0)
        ...
        self.messages_frame: CTkScrollableFrame = CTkScrollableFrame(self, fg_color='yellow', width=944, height=580, corner_radius=0)
